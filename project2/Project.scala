...
object Project {
  ...
  def main(argv: Array[String]): Unit = {
    ...
    val assembler = new VectorAssembler()
      .setInputCols(Array("t1", "t2", "t3", "t4", "t5", "t6", "t7", "t8", "t9", "t10", "t11" ,"t12", "t13","t14","t15","t16","t17","t18","pop"))
      .setOutputCol("features")
    val layers = Array[Int](19, 100, 100, 2)
    ...
    val validation = sc.textFile(input+"validation")
      ...
      .map(y => y.split(","))
      .map(x => (x(0).toInt,x(1),x(2).toDouble,x(3).toDouble,x(4).toDouble,x(5).toDouble,x(6).toDouble,x(7).toDouble,x(8).toDouble,x(9).toDouble,x(10).toDouble,x(11).toDouble,x(12).toDouble,x(13).toDouble,x(14).toDouble,x(15).toDouble,x(16).toDouble,x(17).toDouble,x(18).toDouble,x(19).toDouble,x(20).toDouble))
      .toDF("label", "date", "t1", "t2", "t3", "t4", "t5", "t6", "t7", "t8", "t9", "t10", "t11" ,"t12", "t13","t14","t15","t16","t17","t18","pop")
